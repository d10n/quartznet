...
namespace Quartz.Impl
{
    ...
    /// </summary>
    public abstract class PersistentJobStore<TUnitOfWorkConnection> : IJobStore
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            bool hasMoreMisfiredTriggers = await HasMisfiredTriggersInWaitingState(
                conn, 
        ...
        protected abstract Task<bool> HasMisfiredTriggersInWaitingState(TUnitOfWorkConnection conn,
            int count,
        ...
        /// <inheritdoc />
        public abstract Task TriggeredJobComplete(
        ...
        protected abstract Task ResumeTrigger(
            TUnitOfWorkConnection conn, 
            TriggerKey triggerKey, 
            CancellationToken cancellationToken);
        ...
        public Task ResumeAll(CancellationToken cancellationToken = default)
        {
            return ExecuteInLock(
                LockType.TriggerAccess, 
                conn => ResumeAll(conn, cancellationToken), cancellationToken);
        }

        protected abstract Task ResumeAll(TUnitOfWorkConnection conn, CancellationToken cancellationToken);
        ...
        /// <inheritdoc />
        public abstract Task ReleaseAcquiredTrigger(
            IOperableTrigger trigger,
            CancellationToken cancellationToken = default);

        private Task RetryExecuteInNonManagedLock<T>(LockType lockType, Func<T, Task> func, CancellationToken cancellationToken)
        {
        ...
        protected abstract Task<bool> ReplaceTrigger(
            TUnitOfWorkConnection conn, 
            TriggerKey triggerKey, 
            IOperableTrigger newTrigger, 
            CancellationToken cancellationToken);
        ...
        public Task<bool> RemoveJob(
            ...
            CancellationToken cancellationToken = default)
        {
            return ExecuteInLock(LockType.TriggerAccess, conn => RemoveJob(conn, jobKey, cancellationToken), cancellationToken);
        }

        protected abstract Task<bool> RemoveJob(
            TUnitOfWorkConnection conn,
            JobKey jobKey,
            CancellationToken cancellationToken = default);
        ...
        protected abstract Task<IReadOnlyCollection<FiredTriggerRecord>> SelectFiredTriggerRecordsByJob(ConnectionAndTransactionHolder conn,
            JobKey jobKey,
            CancellationToken cancellationToken);
